      ...
      <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <div className="mb-4">
          ...
          <input
            ...
            className="w-full rounded-lg border border-slate-200 bg-white px-4 py-3 text-sm outline-none transition-all focus:border-slate-400 focus:ring-2 focus:ring-slate-200"
          />
        </div>
      ...
      <div>
        <div className="mb-4 flex items-center justify-between">
          ...
          {searchQuery && (
            <button
              ...
              className="text-sm text-slate-700 hover:text-slate-900 transition-colors font-medium"
            >
              검색 초기화 ×
            </button>
          )}
        ...
        {filteredPerformances.length > 0 ? (
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-12 text-center">
            <p className="text-base font-medium text-slate-400">검색 결과가 없습니다</p>

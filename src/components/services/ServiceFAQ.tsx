...
const FAQS: FAQ[] = [
  {
    ...
    a: "네, 가능합니다. 초대권 이벤트뿐 아니라 유료 공연의 사전 신청·추첨·확정 프로세스에도 동일한 시스템을 활용할 수 있습니다. 결제 연동은 별도 상담을 통해 조율합니다.",
  },
  {
    category: "AdGate",
    q: "보상형 광고(AdGate)는 어떻게 작동하나요?",
    a: "관객이 초대권에 응모하기 전 15초 광고를 시청합니다. 시청 완료 후 응모 자격이 부여되며, 발생한 광고 수익은 공연단체에 배분됩니다. 빈 좌석을 채우면서 동시에 수익을 만드는 구조입니다.",
  },
  {
    category: "콘텐츠",
    q: "SNS 홍보 콘텐츠는 어떤 범위까지 제작해 주나요?",
    a: "카드뉴스, 숏폼(릴스/쇼츠), 관람 포인트 큐레이션, 이벤트 당첨 공지 콘텐츠 등을 제작합니다. 공연 자료(포스터, 사진, 텍스트)를 기반으로 채널별 맞춤 포맷으로 제작됩니다. Growth 이상 플랜에서 제공됩니다.",
  },
  {
    category: "개인정보",
    q: "관객 개인정보는 어떻게 처리되나요?",
    a: "관객이 동의한 범위 내에서만 수집하며, 공연 운영 목적으로만 사용됩니다. 데이터는 암호화 저장되며 개인정보 보호법에 따라 관리됩니다. 파트너 단체에는 집계 데이터·세그먼트 리스트만 제공되며, 개인 식별 정보는 별도 신청 절차를 통해 처리합니다.",
  },
  {
    category: "운영 방식",
    q: "운영은 알터즈가 대행하나요, 단체가 직접 하나요?",
    a: "플랜에 따라 다릅니다. Starter/Growth는 알터즈 매니저가 선정·확정·리마인드를 대행합니다. Pro 플랜은 전담 매니저 배정으로 완전 대행합니다. 직접 운영이 필요한 경우 대시보드 접근권도 협의 가능합니다.",
  },
  {
    category: "운영 방식",
    q: "웨이트리스트는 어떻게 승격되나요?",
    a: "선정된 관객이 확정 기한 내 응답하지 않거나 취소하면 웨이트리스트 1순위가 자동으로 선정 → 확정 안내를 받습니다. 당일 노쇼가 발생하면 체크인 콘솔에서 즉시 처리하고 대기자에게 연락합니다.",
  },
  {
    category: "비용",
    q: "비용은 어떻게 책정되나요?",
    a: "공연 규모, 이벤트 횟수, 필요한 서비스 범위에 따라 달라집니다. AdGate 수익 배분 모델을 활용하면 초기 비용 부담 없이 시작할 수도 있습니다. 상담 후 맞춤 견적을 제공합니다.",
  },
  {
    category: "시작하기",
    q: "시작하려면 무엇을 준비해야 하나요?",
    a: "① 공연 기본 정보(제목·장르·기간·장소) ② 포스터 또는 대표 이미지 ③ 초대권 매수와 공연 회차. 이 세 가지만 준비되면 신청서를 작성해 주세요. 신청 후 1~2영업일 내에 매니저가 연락드립니다.",
  },
]

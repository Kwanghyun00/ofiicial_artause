...
const steps = [
  { title: "이벤트 확인", description: "진행 중인 초대권 이벤트를 확인합니다." },
  { title: "응모 정보 입력", description: "연락처/이메일을 입력하고 응모를 완료합니다." },
  { title: "선정 및 발표", description: "추첨 후 당첨자는 이메일로 안내됩니다." },
  { title: "관람 안내", description: "관람 일정 및 안내 사항을 확인합니다." },
]

const notices = ["1인 1회 응모", "당첨자에게 이메일 안내", "당첨 후 양도 불가", "노쇼/취소 규정 준수"]

export const metadata: Metadata = {
  title: "초대권 응모 가이드",
  description: "초대권 이벤트 참여 과정을 한눈에 정리했습니다.",
  alternates: { canonical: "/invites/guide" },
}

export default function InvitesGuidePage() {
  return (
